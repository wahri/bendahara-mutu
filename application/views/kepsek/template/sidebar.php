        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a href="<?= base_url('kepsek/dashboard') ?>"><i class="fa fa-home"></i> Home </a>
                    <li><a href="<?= base_url('kepsek/laporan') ?>"><i class="fa fa-file-text"></i> Laporan</a></li>
            ...
            <div class="menu_section">
                <h3>Akun</h3>
                <ul class="nav side-menu">
                    <li><a href="<?= base_url('kepsek/profile') ?>"><i class="fa fa-user"></i> Profile </a>
                    </li>
                    <li><a href="<?= base_url('kepsek/pengaturan') ?>"><i class="fa fa-wrench"></i> Pengaturan Akun </a>
                    </li>
