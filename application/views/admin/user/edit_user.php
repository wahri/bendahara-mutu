                ...
                <div class="">
                    ...
                    <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="x_content">
                                    <form action="<?= base_url('admin/user/edit/') . $user_edit['id'] ?>" method="post">

                                        <div class="form-group">
                                            <label>Username <span class="required">*</span></label>
                                            <input type="text" class="form-control" name="username" value="<?= $user_edit['username'] ?>" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label for="level">
                                                    <input type="radio" name="level" value="1" class="flat" <?= $user_edit['level'] == 1 ? 'checked' : '' ?>> Superadmin
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label for="level">
                                                    <input type="radio" name="level" value="2" class="flat" <?= $user_edit['level'] == 2 ? 'checked' : '' ?>> Kepala Sekolah
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label for="level">
                                                    <input type="radio" name="level" value="3" class="flat" <?= $user_edit['level'] == 3 ? 'checked' : '' ?>> Bendahara
                                                </label>
                                            </div>
                                        ...
                                        <a href="" class="btn btn-danger btn-sm">Delete permanently</a>
